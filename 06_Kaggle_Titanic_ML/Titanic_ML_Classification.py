"""
Kaggle Titanic — Machine Learning Classification
=================================================
Analyst: Mintay Misgano
Course: ISM 6359 Data Mining — Seattle Pacific University (Winter 2022)
Kaggle Best Score: 0.79186 (public leaderboard, top ~22%)

Description
-----------
Classic binary classification competition: predict passenger survival on the
Titanic using demographic, cabin class, and ticket features. This script
implements a complete ML pipeline — data cleaning, feature engineering,
multi-model training, and a voting ensemble — that achieves 79.19% accuracy
