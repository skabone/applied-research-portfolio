...
Course: Programming for Data Analytics: Python & ML — SPU (Autumn 2022)

Description
-----------
This script is a unified showcase of the core supervised and unsupervised ML
methods covered in a graduate-level Python ML course. All methods are applied
to a single dataset — U.S. college admissions data (N = 777 institutions) —
allowing direct comparison of approaches on the same problem.
...
People Analytics parallel
-------------------------
This dataset mirrors common workforce analytics structures:
  - Predicting organization type (Private/Public) ~ predicting voluntary attrition (Yes/No)
  - Clustering institutions by profile ~ segmenting employee populations
  - PCA for dimension reduction ~ compressing multi-item engagement survey into components
"""
