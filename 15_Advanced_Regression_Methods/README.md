...
- Start with [Advanced_Regression_Methods_Project_Summary.md](./Advanced_Regression_Methods_Project_Summary.md) for the short overview.
- Use [Advanced_Regression_Methods_Project_Report.md](./Advanced_Regression_Methods_Project_Report.md) for the long-form write-up.
- See [Advanced_Regression_Methods_Project_Report.Rmd](./Advanced_Regression_Methods_Project_Report.Rmd) for the source document.
