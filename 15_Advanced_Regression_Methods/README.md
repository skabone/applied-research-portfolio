...
Ordinary least squares regression fails silently on a common class of outcomes — counts, ranked categories, truncated samples, and censored measurements — producing biased estimates that understate the strength of real relationships. This project applies five models that correct for each violation: Poisson, negative binomial, ordinal logistic, truncated, and Tobit regression. Each model is applied to a dataset whose outcome structure makes OLS inappropriate, and results are compared directly to OLS to show what the misspecification costs.
...
- **[01_Project_Summary.md](./01_Project_Summary.md)** — concise overview of what was found, why it matters, and the key figures.
...
- **[03_Analysis.ipynb](./03_Analysis.ipynb)** — executed notebook with every model, table, and figure produced inline. **[04_Analysis.py](./04_Analysis.py)** is the annotated source script that generates the data, figures, and console output.
