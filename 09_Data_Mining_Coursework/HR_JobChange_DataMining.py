"""
HR Analytics: Predicting Data Scientist Job Change Intention
=============================================================
Analyst: Mintay Misgano
Course: ISM 6359 Data Mining — Seattle Pacific University (Winter 2022)

Description
-----------
A company that trains data scientists wants to identify which candidates
are likely to look for a new job after completing their training program.
This allows the company to optimize resource allocation: investing fully
in candidates likely to remain with them, and adjusting recruitment
strategy for those likely to leave.
...
-------------------------
Predicting which trained employees will seek new employment maps directly
to voluntary attrition prediction:
  - target (1=looking for job) ~ voluntary departure flag
