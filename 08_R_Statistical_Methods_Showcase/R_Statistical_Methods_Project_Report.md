...
The analysis is maintained in [R_Statistical_Methods_Project_Report.Rmd](./R_Statistical_Methods_Project_Report.Rmd), which serves as the source document for the long-form report.
